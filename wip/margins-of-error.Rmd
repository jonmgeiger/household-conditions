...
district_data <- read_excel("../data/NHGIS_District_data.xlsx")
...
- [ ] Start figuring out weighted regression based on standard error
...
If the divided distribution happens to be centered on 1.645, then our estimate is pretty good. If not, then we'll rely on the margin of error calculated by the government for our calculations. 
