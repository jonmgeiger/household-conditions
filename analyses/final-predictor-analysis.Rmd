...
For all of our percentage predictors other than `pct_white`, a log-transformation appeared to make the distributions more symmetric. We will take this into account during the feature engineering stage of creating our final model. Let's now take a look at our other, non-percentage variables. 
